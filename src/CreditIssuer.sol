...
contract CreditIssuer is ICreditIssuer, PausableUpgradeable, OwnableUpgradeable {
    ...
    function __CreditIssuer_init() external virtual onlyInitializing {
        __Ownable_init();
        __Pausable_init();
    }
    ...
    function isActivePeriod(address network, address member) public view returns (bool) {
    ...
    function expireCreditLine(address network, address member) private {
